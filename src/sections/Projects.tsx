  ...
  const projects = [
    {
      ...
      github: 'https://github.com/ramakrishna1973/Voice-Assistant',
      demo: '#',
      color: '#1b45f4',
    },
    {
      ...
      github: 'https://github.com/Rama70275/object-detection-using-yolo',
      demo: '#',
      color: '#1485ff',
    },
    {
      ...
      github: 'https://github.com/SaiVardhan20/Comment-Mining',
      demo: '#',
      color: '#00d4ff',
    },
  ];
